...
```{r}
if(apt == "EDDM") sect <- c(75, 165, 220, 265, 330)     # done
if(apt == "EDDF") sect <- c(0,100,140,215,300,360)      # done
if(apt == "EGLL") sect <- c(0,110,170,230,300,360)      # done
if(apt == "EGKK") sect <- c(0,105,180,300,360)          # done
if(apt == "EHAM") sect <- c(0,70,150,250,310,360)       # done
if(apt == "LFPG") sect <- c(0,90,180,270,360)           # done
if(apt == "LEMD") sect <- c(0,20, 50,95,150, 200, 260,330, 360) # done
if(apt == "LEBL") sect <- c(35, 80, 115, 215, 255, 330)         # check issue with 2022
if(apt == "LIRF") sect <- c(0, 50, 90, 185, 285, 335, 360) # done
